...
public:
	...
	void setMat4fv(const char* uniform, mat4 elements)
	{
		enable();
		glUniformMatrix4fv(glGetUniformLocation(getProgram(), uniform), 1, false, elements.elements);
	}

	void set1iv(const char* uniform, int size, GLint arry[])
	{
